...
passport.serializeUser((user, done) => {//this will generate the indentifying piece of info.
    done(null, user.id);//user.id is the id generated by mongoDB 
});
//in serializeUser turn the user instance into a id
//in deserializeUser turn the id into a mongoose model instance
